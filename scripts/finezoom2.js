(function(d, h) {
    ...
    l.prototype = {onImageLoad: function() {
            ...
            for (var a = this.settings, c = a.markers, b = 0; b < c.length; b++) {
                var standartClassName="fz-marker";
                var f = c[b];
                var g = d('<a class="'+standartClassName+'" />').css({left: f.left, top: f.top}).data("pos", {left: f.left, top: f.top}).appendTo(this.wrapper);
                "function" == typeof f.click && g.bind("click", f, function(b) {
                    b.data.click.call(this);
                });
                "function" == typeof f.mouseenter && g.bind("mouseenter", f, function(b) {
                    b.data.mouseenter.call(this);
                });
                "function" == typeof f.mouseleave && g.bind("mouseleave", f, function(b) {
                    b.data.mouseleave.call(this);
                });
                
                f["class"] && g.addClass(f["class"]);
                this.use_css3 && (g.addClass("fz-animate2"), g.css(this.transDur, a.zoom_duration + "ms"))
                if( typeof f.styleClass != 'undefined' ){
                    g.removeClass(standartClassName);
                    g.addClass(f.styleClass);
                };
